...
interface KidsProductsClientProps {
  products: Product[]
}

export default function KidsProductsClient({ products = [] }: KidsProductsClientProps) {
                ...
                <CardFooter className="p-0 pt-6">
                  ...
                  >
                    ...
                    <CardDescription className="text-xs text-gray-600 font-light mb-3 leading-relaxed">
                      {product.description || "Fun and comfortable styles for kids."}
                    </CardDescription>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex space-x-1">
                        {product.colors.slice(0, 3).map((color, colorIndex) => {
                          // Better color mapping for display - includes kids-friendly colors
