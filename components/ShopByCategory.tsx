...
export default function ShopByCategory() {
  return (
    <section className="py-24 container mx-auto px-4" style={{ fontFamily: '"Inter", sans-serif' }}>
      {/* Section Title - Pure Zara minimalism */}
      <motion.div
      ...
      {/* Categories Grid - Zara's asymmetric approach */}
          ...
          >
            <Card className="border-0 shadow-none bg-transparent overflow-hidden">
              <CardContent className="p-0">
                {/* Image Container - Zara's signature proportions */}
                <div className="relative overflow-hidden bg-gray-50 mb-4">
                  <AspectRatio ratio={4/5}>
                    ...
                    >
                      ...
                      {/* Zara's signature dark gradient overlay */}
                      <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-black/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                    </motion.div>

                    {/* Floating category label - appears on hover */}
                    <motion.div
                      initial={{ opacity: 0, y: 20 }}
                    ...
                    {/* Shop now button - slides up from bottom */}
                    <motion.div
                      initial={{ y: "100%" }}
                      whileHover={{ y: "0%" }}
              ...
              {/* Category Name - Minimal Zara style */}
              <motion.div
                initial={{ opacity: 0.8 }}
      ...
      {/* Additional Zara-style footer text */}
      <motion.div
        initial={{ opacity: 0 }}
