...
interface WomenProductsClientProps {
  products: Product[]
}
  ...
  if (!products || products.length === 0) {
    return (
      <section className="py-24 container mx-auto px-4" style={{ fontFamily: '"Inter", sans-serif' }}>
        ...
        >
          <h1 className="text-3xl md:text-5xl font-thin tracking-[0.02em] mb-4 text-black"
                ...
                <CardFooter className="p-0 pt-6">
                  ...
                  >
                    ...
                    <CardDescription className="text-xs text-gray-600 font-light mb-3 leading-relaxed">
                      {product.description || "Premium quality and timeless style."}
                    </CardDescription>
