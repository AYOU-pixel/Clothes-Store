...
import AccessoriesProductsClient from "@/components/AccessoriesProductsClient";
...
export default async function AccessoriesPage() {
  try {
    ...
    if (!accessoriesCategory) {
      return (
        <div className="container mx-auto px-4 py-24 text-center">
          ...
          <p className="text-gray-600">The accessories category could not be found.</p>
        </div>
      )
    }
    ...
    return <AccessoriesProductsClient products={products} />
